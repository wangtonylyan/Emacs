...
(use-package prog-mode
  :hook (after-init . pkg/prog-mode/init)
  :preface
...
(use-package yasnippet
  ...
  :hook (after-init . pkg/yasnippet/init)
  :preface
...
(use-package company
  ...
  :hook (after-init . pkg/company/init)
  :preface
...
(use-package auto-complete
  :hook (after-init . pkg/auto-complete/init)
  :preface
...
(use-package flymake
  :hook (after-init . pkg/flymake/init)
  :preface
...
(use-package flycheck
  ...
  :hook (after-init . pkg/flycheck/init)
  :preface
...
(use-package ggtags
  ...
  :hook (after-init . pkg/ggtags/init)
  :preface
...
(use-package helm-gtags
  :after (helm)
  :hook (after-init . pkg/helm-gtags/init)
  :preface
